...
#include<stdlib.h>
using namespace std;
string admin("shivam"),password("12345678");
string user("user"),password1("789456");
int bill=0;
string customers[30]={"rohit","rajnish","Mohit","kashish","sonam","shiva","suresh","shonal","ram","shivam","srinu","salu","sumit","sourav","hari"};
